  ...
  return (
    <>
      ...
      <div 
        ...
        className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 scroll-smooth bg-[#F2F2F7]"
      >
        <div className="max-w-6xl 2xl:max-w-7xl mx-auto space-y-6">
          
          {/* Tab buttons */}
          <div className="bg-slate-200/60 p-1 rounded-2xl flex gap-1 max-w-lg border border-slate-200/50 shadow-inner">
            <button 
              onClick={() => setActiveTab('study')}
              className={`flex-1 py-2.5 text-center text-xs font-extrabold rounded-xl cursor-pointer transition-all duration-200 select-none active:scale-95 ${
                activeTab === 'study' 
            ...
            {activeTab === 'study' && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-amber-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-amber-800 uppercase tracking-wider">Ca Sáng</h3>
                    <span className="text-[10px] text-amber-600 font-bold bg-amber-100/60 px-2 py-0.5 rounded-full">Tiết 1 – 6</span>
                  </div>
                    ...
                    {studySáng.map((item, idx) => (
                      item.session === 'Break' ? (
                        ...
                        <div key={idx} className="flex justify-between items-center px-5 py-3.5 hover:bg-slate-50/50 transition-colors">
                          <span className="font-extrabold text-slate-800 text-xs">Tiết {item.period}</span>
                          <span className="text-slate-600 font-bold font-mono tracking-tight text-xs">{item.time}</span>
                        </div>
                      )
                    ))}
                  </div>
                ...
                {/* Ca Chiều */}
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-blue-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-blue-800 uppercase tracking-wider">Ca Chiều</h3>
                    <span className="text-[10px] text-blue-600 font-bold bg-blue-100/60 px-2 py-0.5 rounded-full">Tiết 7 – 12</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
                ...
                {/* Ca Tối */}
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-indigo-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-indigo-800 uppercase tracking-wider">Ca Tối</h3>
                    <span className="text-[10px] text-indigo-600 font-bold bg-indigo-100/60 px-2 py-0.5 rounded-full">Tiết 13 – 16</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
            ...
            {activeTab === 'exam60' && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-amber-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-amber-800 uppercase tracking-wider">Ca Sáng</h3>
                    <span className="text-[10px] text-amber-600 font-bold bg-amber-100/60 px-2 py-0.5 rounded-full">Thi 60 Phút</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
                    {exam60Sáng.map((item, idx) => (
                      <div key={idx} className="flex justify-between items-center px-5 py-3.5 hover:bg-slate-50/50 transition-colors">
                        ...
                        <div className="text-right">
                          <span className="text-[#002147] font-extrabold font-mono tracking-tight text-xs sm:text-sm">{item.start}</span>
                          <span className="block text-[9px] text-[#B45309] font-bold uppercase tracking-wider mt-0.5">Giờ phát đề</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-blue-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-blue-800 uppercase tracking-wider">Ca Chiều</h3>
                    <span className="text-[10px] text-blue-600 font-bold bg-blue-100/60 px-2 py-0.5 rounded-full">Thi 60 Phút</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
                ...
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-indigo-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-indigo-800 uppercase tracking-wider">Ca Tối</h3>
                    <span className="text-[10px] text-indigo-600 font-bold bg-indigo-100/60 px-2 py-0.5 rounded-full">Thi 60 Phút</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
            ...
            {activeTab === 'exam90' && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-amber-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-amber-800 uppercase tracking-wider">Ca Sáng</h3>
                    <span className="text-[10px] text-amber-600 font-bold bg-amber-100/60 px-2 py-0.5 rounded-full">Thi 90 Phút</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
                ...
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-blue-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-blue-800 uppercase tracking-wider">Ca Chiều</h3>
                    <span className="text-[10px] text-blue-600 font-bold bg-blue-100/60 px-2 py-0.5 rounded-full">Thi 90 Phút</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
                ...
                <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden flex flex-col">
                  <div className="bg-indigo-50/50 border-b border-slate-150 px-5 py-4 flex items-center justify-between">
                    <h3 className="text-xs font-extrabold text-indigo-800 uppercase tracking-wider">Ca Tối</h3>
                    <span className="text-[10px] text-indigo-600 font-bold bg-indigo-100/60 px-2 py-0.5 rounded-full">Thi 90 Phút</span>
                  </div>
                  <div className="divide-y divide-slate-100 flex-1 bg-white">
